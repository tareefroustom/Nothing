...
with col1:
    #st.header()
    AppId = title = st.text_input('Enter your App ID', "7a236e7c-cba2-48fd-b61b-3584186ff918")

with col2:
    #st.header()
    AppAPI = title = st.text_input('Enter your API Key', "a2bdw98jjaesx1jfrh5n5l2lo")

with col1:
    #st.header()
    UsersCollectionId = title = st.text_input('Enter the ID of your users collections', "t_1da86ee63a5e4e35abfd359b2d89e275")
